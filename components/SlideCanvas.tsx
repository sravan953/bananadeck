...
export const SlideCanvas: React.FC<SlideCanvasProps> = ({ slides, presentationStyle, isLoading, loadingMessage, onExpand, isExpandedView, onGoBack, onStartSlideshow }) => {
  if (isLoading) {
        ...
        <div className="flex items-center gap-4">
          ...
          {slides.length > 0 && (
            <button 
              ...
              className="flex items-center gap-2 bg-sky-600 hover:bg-sky-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors text-sm"
